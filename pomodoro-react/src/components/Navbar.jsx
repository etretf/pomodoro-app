...
export default function Root(){
    ...
    return(
        ...
        <div className="navbar-start">
            ...
            {/* mini-timer */}
            <div className="mini-timer join px-2 py-1 border border-2 rounded-xl min-w-fit mx-5 bg-base-300">
                <h3 className="text-lg mx-1">Study</h3>
                <h3 className="text-lg mx-1">20:31</h3>
            </div>
        </div>
